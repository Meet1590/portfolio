        ...
        <div className="flex justify-between flex-col p-8 h-full w-full">
          ...
          <div>
            <div className="flex items-center truncate">
              <div className="card-title text-lg font-semibold tracking-tight flex text-base-content">
                <MdInsertLink className="my-auto opacity-70 mr-1" />
            ...
            {/* Description */}
            {item.description && (
              <p className="mb-5 mt-2 text-sm text-base-content/80 leading-relaxed text-justify">
                {item.description}
              </p>
            )}
          </div>
          ...
          {/* Footer */}
          <div className="flex justify-between text-xs text-base-content/60 truncate mt-1">
            <div className="flex grow">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
              <div className="flex items-center space-x-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="text-base-content/60 text-sm mt-1 truncate">
                    {loading
